    ...
    curriculum: [
      {
        ...
        desc: "Semantic HTML, CSS box model, flexbox, grid, responsive design, and building pixel-perfect layouts",
      },
      {
        week: "Week 3–4",
        title: "JavaScript Essentials",
        desc: "Variables, functions, arrays, objects, DOM manipulation, events, ES6+ features (arrow functions, destructuring, spread)",
      },
      {
        week: "Week 5–6",
        title: "ReactJS Fundamentals",
        desc: "Components, props, state, hooks (useState, useEffect), React Router, and building interactive UIs",
      },
      {
        week: "Week 7–8",
        title: "Next.js & Modern React",
        desc: "Pages and routing, server-side rendering, API routes, image optimisation, and deploying with Vercel",
      },
      {
        week: "Week 9–10",
        title: "Node.js & Express Backend",
        desc: "Setting up a Node server, REST API design, middleware, authentication with JWT, and connecting to databases",
      },
      {
        week: "Week 11–12",
        title: "Full-Stack Capstone Project",
        desc: "Build and deploy a complete full-stack web application from scratch — frontend, backend, database, and production deployment",
      },
    ],
  },
